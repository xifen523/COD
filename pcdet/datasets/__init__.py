...
from .kitti.kitti_dataset_img_lidar import KittiDatasetV2
from .kitti.v2x_i_dataset import V2XIDataset
...
__all__ = {
    ...
    'KittiDatasetV2': KittiDatasetV2,
    'V2XIDataset': V2XIDataset,
}
